namespace :i18n_db do
  ...
  task :create_tables => :environment do
    ...
    ActiveRecord::Base.connection.add_index :i18n_db_translations, [ :tr_key, :locale_id, :updated_at ], :name => :index_i18n_db_translations_on_tr_key_and_locale_id__updated_at
