module DVDPost
  class << self
    ...
    def product_linked_recommendations(product, customer)
      url = "http://partners.thefilter.com/DVDPostService/RecommendationService.ashx?cmd=DVDRecommendDVDs&id=#{product.id}&number=25"
      open url do |data|
