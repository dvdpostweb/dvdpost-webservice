class Customer < ActiveRecord::Base
  ...
  def self.abo_missing
    ...
    results.each_hash do |h|
        Emailer.deliver_send('it@dvdpost.be, cl@dvdpost.be, custserv@dvdpost.be', "missing abo type #{Date.today}", "dvdpost customers :  #{h['list']} have trouble with thier subscription (customers_abo_type or customers_next_abo_type")
    end
  end
end