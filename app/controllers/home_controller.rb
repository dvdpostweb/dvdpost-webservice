  ...
  def index
    respond_to do |format|
      format.html {
        ...
        @top_title = ProductList.by_language(DVDPost.product_languages[I18n.locale]).find_by_home_page(true).name
        @soon = Product.normal.available.soon.ordered_rand.limit(3)
        @new = Product.normal.available.new_products.ordered_rand.limit(3)
